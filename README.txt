Click on the batch script and run the module.
Requires Python 3.*.

Edit the code to reflect your Gmail settings and paths, and also create an App Password https://support.google.com/accounts/answer/185833.
This is supposed to be used as an alternative RSA feed for Gmail messages.
As of 11/2018, there is no functionality to do this(coming soon).
